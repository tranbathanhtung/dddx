...
export namespace Filesystem {
  ...
  /** Parse JSON when present and valid; otherwise return null (never throws). */
  export async function readJsonIfValid<T = any>(p: string): Promise<T | null> {
    try {
  ...
  export async function* walkFiles(
    cwd: string,
    opts?: { dot?: boolean; extensions?: string[] },
