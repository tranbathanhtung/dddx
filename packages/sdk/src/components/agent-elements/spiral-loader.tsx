...
/** CJS/ESM: default import is sometimes the namespace `{ default: Lottie }`. */
const Lottie = (
  typeof LottieImport === "function"
    ? LottieImport
    : (LottieImport as { default: FC<LottieComponentProps> }).default
) as FC<LottieComponentProps>;
...
export function SpiralLoader({ size = 16, className }: SpiralLoaderProps) {
  ...
  return (
    <div
      className={cn("relative shrink-0 dark:invert", className)}
