...
/** Passed when `emptyContent` is a render function (e.g. to fill the composer from starter prompts). */
export type AgentChatEmptyRenderContext = {
...
export type AgentChatProps = {
  ...
  emptyContent?:
    | React.ReactNode
    | ((ctx: AgentChatEmptyRenderContext) => React.ReactNode);
  ...
  attachments?: {
    ...
    customContexts?: { id: string; value: string; name: string }[];
...
export type AnAgentChatEmptyRenderContext = AgentChatEmptyRenderContext;
